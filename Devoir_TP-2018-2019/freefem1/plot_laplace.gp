...
plot [0.001:0.2] "output/laplace_errors_umfpack.txt" u 1:2 w lp ls 1 t 'Nom L^2', "output/laplace_errors_umfpack.txt" u 1:3 w lp ls 1 lt rgb "blue" t 'Norm H^1'

set output "output/laplace_cpu.pdf"
set ylabel "temps (s)"
set key top right
plot [0.001:0.2] "output/laplace_errors_umfpack.txt" u 1:4 w lp ls 1 t 'temps CPU -- UMFPACK'
